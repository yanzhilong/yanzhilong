...
namespace yanzhilong.Menu
{
    public class XmlSiteMap
    {
        ...
        private static void PopulateNode(SiteMapNode siteMapNode, XmlNode xmlNode)
        {
            ...
            //title
            var nopResource = GetStringValueFromAttribute(xmlNode, "crsResource");
            siteMapNode.Title = nopResource;
            //var localizationService = EngineContext.Current.Resolve<ILocalizationService>();
            //var title = localizationService.GetResource(nopResource);
            //if(title == nopResource)
            //{
            //    siteMapNode.Title = nopResource;
            //}
            //else
            ...
            if (!string.IsNullOrEmpty(controllerName) && !string.IsNullOrEmpty(actionName))
            {
                ...
                //apply admin area as described here - http://www.crs.com/boards/t/20478/broken-menus-in-admin-area-whilst-trying-to-make-a-plugin-admin-page.aspx
